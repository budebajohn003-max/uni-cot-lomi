...
try:
    ...
    CountdownCard = None
    ExternalTable = None
    ExternalTableRecord = None
    ImagePost = None
    Property = None
    User = None
    UserGroup = None
    SystemSetting = None
    RegistrationFormField = None
...
if RegistrationFormField is not None:
...
if ExternalTableRecord is not None:
